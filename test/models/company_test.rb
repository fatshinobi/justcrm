...
class CompanyTest < ActiveSupport::TestCase
  ...
  test "get unremoved company people" do
    company = companies(:mycrosoft)
    assert_equal 2, company.company_people.unremoved.size

    person = company.company_people.unremoved.first.person
    person.set_condition :removed
    person.save

    company.reload
    assert_equal 1, company.company_people.unremoved.size		
  end
  ...
  test "have people through" do
    company = companies(:mycrosoft)
    assert_equal 2, company.people.size
